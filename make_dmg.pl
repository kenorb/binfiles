...
use Mac::Alias::Parse    '0.20';
use Mac::Alias::Parse    qw( pack_alias );
use MIME::Base64         qw( );
...
sub windowEntries {
    ...
    $pictAlias = &pack_alias(%$pictAliasFields);
...
sub dmgFileAlias {
    ...
    # Build up the alias record fields needed by Mac::Alias::Parse::pack_alias.
    %alis = (
